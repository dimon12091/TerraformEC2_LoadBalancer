...
# Enter-PSSession -ComputerName "$hostip1" -Credential $creds1
Invoke-Command -ComputerName $hostip1 -Credential $creds1 -FilePath .\scripts\deploy_site.ps1
...
Invoke-Command -ComputerName $hostip2 -Credential $creds2 -FilePath .\scripts\deploy_site.ps1
